...
#The Following script is a general firewall management script that effectively checks for UFW/Firewalld, if not detected prompts user to install
#their firewall of choice then proceeds to offer options for firewall management.
